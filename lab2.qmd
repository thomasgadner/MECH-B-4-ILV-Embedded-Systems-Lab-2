...
(Optional)
1. Verbinden Sie eine Sonde des Oszilloskops mit dem GPIO-Pin (z.B., PA5 oder PB0), der den Motor oder die LED steuert.
2. Stellen Sie sicher, dass das Oszilloskop korrekt konfiguriert ist:
   - **Zeitbasis**: Wählen Sie eine geeignete Zeitbasis, um das PWM-Signal zu sehen.
...
3. Beobachten und analysieren Sie das Signal:
   - Überprüfen Sie die Frequenz und Pulsbreite des PWM-Signals für verschiedene Geschwindigkeiten/Helligkeiten.
...
- Die Konzepte einer Zustandsmaschine verstanden haben.
- Wissen, wie man UART-Kommunikation implementiert und dekodiert.
- In der Lage sein, Motoren und LEDs basierend auf empfangenen Befehlen zu steuern.
- Die Bedeutung von Datenintegrität durch CRC-Prüfung verstanden haben.
